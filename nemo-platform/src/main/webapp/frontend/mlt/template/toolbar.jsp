			...
			<li style="margin-left: 30px">
				...
				<div class="btn-group" role="group">
					<button id="btn-undo" class="btn btn-default navbar-btn"
						data-tooltip="Undo">
						<img style="height: 24px" src="frontend/mlt/img/undo.png"
							alt="Undo">
					</button>

					<button id="btn-redo" class="btn btn-default navbar-btn"
						data-tooltip="Redo">
						<img style="height: 24px" src="frontend/mlt/img/redo.png"
							alt="Undo">
					</button>

					<button id="btn-clear" class="btn btn-default navbar-btn"
						data-tooltip="Clear">
						<img style="height: 24px" src="frontend/mlt/img/clear.png"
							alt="Undo">
					</button>
